...
<div class="container">
    <br>
<h1><a style="text-decoration:none;color:#000;" href="<?php echo ADMIN_URL.'cart_ordered.php';?>">Customer Cart</a></h1>
...
<!-- ================================SEARCH SECTION======================================== -->
        ...
        // =========================================================================================        
            ...
            $table2 = "SELECT * FROM tbl_user_items WHERE `user_name`='$title'";
            $res2 = $viewUser->get_query($table2);
            $num = $res2->num_rows;
        ...
        ?>
            <div class="column">
            <a href="customer_cart_info.php?id=<?php echo $id;?>">
                    <div class="card">
                        <h3><small><?php echo $title;?> :</small> <br><?php echo $num; ?> <small>Item Pending</small></h3>
                    </div>
                    </a>
            </div>
        <?php 
