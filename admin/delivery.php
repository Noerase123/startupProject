...
<div class="container">
    <br>
<h1><a style="text-decoration:none;color:#000;" href="<?php echo ADMIN_URL.'delivery.php';?>">Delivery</a></h1>
        ...
        if (isset($_GET['query']) && isset($_GET['searchbtn'])) {
            ...
            if ($num_result > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        $table2 = "SELECT * FROM tbl_deliver_process WHERE `user_name`='$title'";
                        $res2 = $viewUser->get_query($table2);
                        $num = $res2->num_rows;
                        
                    ?>
                    <div class="column">
                        <a href="delivery_info.php?id=<?php echo $id;?>">
                            <div class="card">
                                <h3><small><?php echo $title;?> :</small> <br><?php echo $num; ?><small>Item Delivering</small></h3>
                            </div>
                        </a>
                    </div>
                    <?php
