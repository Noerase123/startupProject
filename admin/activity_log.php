...
<div style="background-color:#f1f1f1;padding:1px;"><h4>&nbsp &nbsp <a style="color:#000;text-decoration:none;" href="<?php echo ADMIN_URL.'product_category.php';?>">Dashboard</a> > Activity log</h4></div>
...
<?php 
$qry = "SELECT * FROM tbl_stack WHERE category = 'romance'";
